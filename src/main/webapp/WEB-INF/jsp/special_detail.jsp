...
<head>
    ...
    <title>${special.name} - TMP旅游指南</title>
            ...
            <article class="dnew-con dnew-con1">
                ...
                <aside class="dnew-left">
                    <section class="dleft-box">
                        <div id="Topics">
                            <div id="Topics_big">
                                <img src="${pageContext.request.contextPath}/special/img/${special.sid}"
                                     alt="${special.name}" title="${special.name}"/>
                            </div>
                        ...
                        <section class="dnew-jj">
                            <header class="dnew-title">
                                <div class="dtitle">
                                    <em class="jj-icon"></em>
                                    <h2><a href="#">${special.voAid}-${special.name}-特产详情</a>
                                    </h2>
                                </div>
                            </header>
                            <div class="lygs-link">
                            ...
                            <div class="lygs-link">
                                <div class="dnew-sum">
                                    <dl>
                                        ...
                                        <dd>
                                            <h3>${special.name}-特产购买信息</h3>

                                            <div class="price-yd">
			<span class="sq-price">
                                                        <span class="ph">&yen</span>${special.price}<span class="pb"></span>
                                                    </span>
                                                <div class="clear"></div>
                                            </div>
