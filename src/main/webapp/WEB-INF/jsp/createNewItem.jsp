                            ...
                            <div class="lygs-link">
                                ...
                                <div class="dnew-sum">
                                    <form action="/shoppingCart/add" method="post">
                                        <label>商品种类：</label><input value="${kind}" readonly="readonly" type="text" class="text " name="kind" > <div>&nbsp;&nbsp;</div>
                                        <label>商品单价：</label><input value="${price}" readonly="readonly" type="text" class="text " name="price" > <div>&nbsp;&nbsp;</div>
                                        <label>商品名称：</label><input value="${name}" readonly="readonly" type="text" class="text " name="name" > <div>&nbsp;&nbsp;</div>
                                        <label>购买数量：</label><input type="text" class="text " name="count" > <div>&nbsp;&nbsp;</div>
                                        <input id="sub" type="submit" style="" value="加 到 购 物 车" >
                                    </form>
                                </div>
                            </div>
                        </section>
