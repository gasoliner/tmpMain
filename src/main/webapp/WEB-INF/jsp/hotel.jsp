...
<head>
    <title>发现酒店 - 景点大全 - 热门景点 - 景点图片 - TMP旅游指南</title>
                ...
                <div style="height: auto" class="view-address">
                    ...
                    <div>
                        <div class="va-content">
                            ...
                            <h3>酒店地址</h3>&nbsp;&nbsp;<p>${hotel.addr}</p><div>&nbsp;</div>
                            <h3>酒店评分</h3>&nbsp;&nbsp;<p>${hotel.score}</p><div>&nbsp;</div>
                            ...
                            <%--<dl style="width: 100%" class="yz-view">--%>
                                ...
                                <%--<c:forEach items="${attraction.voAttractionList}" var="att">--%>
                                    <%--<dd style="width: auto"><a href="${pageContext.request.contextPath}/attraction/detail/${att.aid}" target="_blank">${att.name}</a></dd>--%>
                                <%--</c:forEach>--%>
                            <%--</dl>--%>
                        </div>
                    </div>
