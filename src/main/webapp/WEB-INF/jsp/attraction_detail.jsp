...
<head>
    ...
    <title>${attraction.name} - TMP旅游指南</title>
    ...
    <div id="header">
        ...
        <header class="dnew-hno">
            ...
            <div class="dnew-bq dnew-no">
                <a href="#" title="${attraction.voRid}">在${attraction.voRid}</a>
            </div>
            <div class="clear"></div>
        </header>
        <!--没头图 end-->
                    ...
                    <section class="dleft-box">
                        ...
                        <section class="dnew-jj">
                            <header class="dnew-title">
                                <div class="dtitle">
                                    <em class="jj-icon"></em>
                                    <h2><a href="#">${attraction.name}旅游概述</a>
                                    </h2>
                                </div>
                            </header>
                            <div class="lygs-link">
                            ...
                            <div class="lygs-link">
                                <div class="dnew-sum">
                                    <dl>
                                        ...
                                        <dd>
                                            <h3>${attraction.name}门票</h3>

                                            <div class="price-yd">
			<span class="sq-price">
                                                        <span class="ph">&yen</span>${attraction.price}<span class="pb"></span>
                                                    </span>
                                                <div class="clear"></div>
                                            </div>
                                            <div class="tfour-c"><a href="${pageContext.request.contextPath}/shoppingCart/createNewItem?kind=门票&price=${attraction.price}&name=${attraction.name}门票"
                ...
                <aside class="dnew-right">
                    ...
                    <%--<div name="ad57" class="google-ad" style="margin-bottom: 10px;"></div>--%>
                    ...
                    <section class="dnew-312 bd">
                        <header class="d312-title">
                            <h3>${attraction.name}出行日历</h3>
                        </header>
                        <div class="cxrj-con">
                            <p><em class="cxrj-icon"></em><b>开放时间：</b><br/>${attraction.opentime}</p>
                        </div>
                    </section>
                    <div class="blank"></div>
