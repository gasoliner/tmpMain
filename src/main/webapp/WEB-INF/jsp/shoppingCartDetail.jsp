...
<div id="content">
    ...
    <div id="header">
        ...
        <div style="height: 350px;overflow:hidden">
            <img style="width: 100%;" src="/ui/img/bg-7.jpg">
        </div>
        <div class="clear"></div>
                    ...
                    <section class="dleft-box">
                        ...
                        <section class="dnew-jj">
                            ...
                            <div class="lygs-link">
                                ...
                                <div class="dnew-sum">
                                    <hr/>
                                    <c:forEach items="${menpiao}" var="item1">
                                        <label>门票名称</label>&nbsp;&nbsp; | &nbsp;&nbsp; ${item1.var} <div>&nbsp;</div>
                                        <label>门票价格</label>&nbsp;&nbsp; | &nbsp;&nbsp; ${item1.price} <div>&nbsp;</div>
                                        <label>数量</label>&nbsp;&nbsp; | &nbsp;&nbsp; ${item1.count} <div>&nbsp;</div>
                                        <hr/>
                                    </c:forEach>
                                </div>
                            </div>
                        ...
                        <section class="dnew-jj">
                            ...
                            <div class="lygs-link">
                                <%--<a href="http://trip.elong.com/yadingziranbaohuqu/jianjie/" target="_blank">简介</a>  |  <a href="http://trip.elong.com/yadingziranbaohuqu/jiaotong/" target="_blank">交通</a>  |  					</div>--%>
                                    ...
                                    <div class="dnew-sum">
                                        <hr/>
                                        <c:forEach items="${jiudian}" var="item2">
                                            <label>酒店及房型名称</label>&nbsp;&nbsp; | &nbsp;&nbsp; ${item2.var} <div>&nbsp;</div>
                                            <label>价格</label>&nbsp;&nbsp; | &nbsp;&nbsp; ${item2.price} <div>&nbsp;</div>
                                            <label>数量</label>&nbsp;&nbsp; | &nbsp;&nbsp; ${item2.count} <div>&nbsp;</div>
                                            <hr/>
                                        </c:forEach>
                                    </div>
                            </div>
                        ...
                        <section class="dnew-jj">
                            ...
                            <div class="lygs-link">
                                <%--<a href="http://trip.elong.com/yadingziranbaohuqu/jianjie/" target="_blank">简介</a>  |  <a href="http://trip.elong.com/yadingziranbaohuqu/jiaotong/" target="_blank">交通</a>  |  					</div>--%>
                                    ...
                                    <div class="dnew-sum">
                                        <hr/>
                                        <c:forEach items="${techan}" var="item3">
                                            <label>特产名称</label>&nbsp;&nbsp; | &nbsp;&nbsp; ${item3.var} <div>&nbsp;</div>
                                            <label>特产单价</label>&nbsp;&nbsp; | &nbsp;&nbsp; ${item3.price} <div>&nbsp;</div>
                                            <label>数量</label>&nbsp;&nbsp; | &nbsp;&nbsp; ${item3.count} <div>&nbsp;</div>
                                            <hr/>
                                        </c:forEach>
                                    </div>
                            </div>
                        ...
                        <section class="dnew-jj">
                            ...
                            <div class="lygs-link">
                                <%--<a href="http://trip.elong.com/yadingziranbaohuqu/jianjie/" target="_blank">简介</a>  |  <a href="http://trip.elong.com/yadingziranbaohuqu/jiaotong/" target="_blank">交通</a>  |  					</div>--%>
                                    <style>
                                        #sub{font-size:16px;width:200px;height:35px;line-height:35px;background:transparent url(/ui/sub.png) no-repeat;border:none;}
                                    </style>
                                <div class="dnew-sum">
                                    <div class="price-yd">
			                            <span class="sq-price">
                                            <span class="ph">&yen</span>${sum}<span class="pb"></span>元
                                        </span>
                                        <div class="clear"></div>
                                    </div>
                                    <style>
                                    ...
                                    <form action="/shoppingCart/submitOrder" method="post">
                                        <%--<input id="sub" type="submit" style="" value="提交订单并支付" >--%>
                                        <input  type="submit" style="font-size:16px;width:200px;height:35px;line-height:35px;background:transparent url(/ui/sub.png) no-repeat;border:none;" value="提交订单并支付" >
                                    </form>
                                </div>
                            </div>
                        </section>
