...
<head>
    ...
    <title>${hotel.name} - TMP旅游指南</title>
    ...
    <div id="header">
        ...
        <header class="dnew-hno">
            ...
            <div class="dnew-bq dnew-no">
                <a href="#" title="${hotel.addr}">在${hotel.addr}</a>
            </div>
            <div class="clear"></div>
        </header>
        <!--没头图 end-->
                    ...
                    <c:forEach items="${houseList}" var="house">
                        ...
                        <section class="dnew-jj">
                            <header class="dnew-title">
                                <div class="dtitle">
                                    <em class="jj-icon"></em>
                                    <h2><a href="#">房型 - ${house.name}</a>
                                    </h2>
                                </div>
                            </header>
                            <div class="blank10"></div>
                            <img style="width: 300px" src="/house/img/${house.hoid}"/>
                            <div class="lygs-link">
                                <div class="dnew-sum">
                                    <dl>
                                        <dt>
                                        ...
                                        <dd>
                                            <h3>${house.name}-床位数</h3><p>${house.bedcount}张</p>
                                            <h3>${house.name}-星级</h3><p>${house.star}</p>
                                            <h3>${house.name}-网络</h3><p>${house.iswifi}</p>
                                            <h3>${house.name}-简介</h3><p>${house.info}</p>

                                            <div class="price-yd">
			<span class="sq-price">
                                                        <span class="ph">&yen</span>${house.price}<span class="pb">/天</span>
                                                    </span>
                                                <div class="clear"></div>
                                            </div>
                                            <div class="tfour-c">
                                                <a href="${pageContext.request.contextPath}/shoppingCart/createNewItem?kind=酒店&price=${house.price}&name=${house.voHid}-${house.name}住宿至少可住${house.bedcount}人"
                ...
                <aside class="dnew-right">
                    ...
                    <section class="dnew-312 bd">
                        ...
                        <div class="cxrj-con">
                            <p><em class="cxrj-icon"></em><b>地址：</b><br/>${hotel.addr}</p>
                            <p><em class="cxrj-icon"></em><b>星级：</b><br/>${hotel.star}</p>
                            <p><em class="cxrj-icon"></em><b>评分：</b><br/>${hotel.score}</p>
                            <p><em class="cxrj-icon"></em><b>联系方式：</b><br/>${hotel.phone}</p>
                            <p><em class="cxrj-icon"></em><b>简介：</b><br/>${hotel.info}</p>
                        </div>
                    </section>
                    <div class="blank"></div>
                    ...
                    <!--自定义模块-->
                    <!--自定义模块 end-->
                    <!--			<section class="bd" style="height:252px;">
                                        <div class="gg-ad" style="width:300px;height:250px;margin:1px auto 0;">
                                            AdForward Begin:
                    <script type="text/javascript" ads-src="http://elongim.qtmojo.com/main/s?user=elong|Trip|AD300x250&db=elongim&border=0&local=yes&js=ie" src="http://creatim.qtmojo.cn/td/AllyesDeliver.min.js" charset="gbk"></script>
                    AdForward End
                                    </div>
                                </section>-->
